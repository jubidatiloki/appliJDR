...
public class PersoManager {
    ...
    public static final int NUM_COL_INVENTAIRE = 5;

    private static final String COL_NOTEPERSO = "notePerso";
    public static final int NUM_COL_NOTEPERSO = 6;

    private static final String COL_NIVEAU = "niveau";
    public static final int NUM_COL_NIVEAU = 7;

    private static final String COL_DEFENSE = "defense";
    public static final int NUM_COL_DEFENSE = 8;

    private static final String COL_INITIATIVE = "initiative";
    public static final int NUM_COL_INITIATIVE = 9;

    private static final String COL_FOR = "FOR";
    public static final int NUM_COL_FOR = 10;

    private static final String COL_DEX = "DEX";
    public static final int NUM_COL_DEX = 11;

    private static final String COL_CON = "CON";
    public static final int NUM_COL_CON = 12;

    private static final String COL_INT = "INT";
    public static final int NUM_COL_INT = 13;

    private static final String COL_SAG = "SAG";
    public static final int NUM_COL_SAG = 14;

    private static final String COL_CHA = "CHA";
    public static final int NUM_COL_CHA = 15;
    ...
    public int updateByNumCol(Perso perso, String nomCol, String modif){
        ContentValues values = new ContentValues();
        values.put(COL_IDPERSO, perso.getIdPerso());
        values.put(COL_NOM, perso.getNom());
        values.put(COL_CLASSE, perso.getClasse());
    ...
    public Perso getPersoByNom(String nom){
        ...
        Cursor c = bdd.query(TABLE_PERSO, new String[] {COL_IDPERSO, COL_NOM, COL_CLASSE, COL_RACE, COL_DESCRIPTION, COL_INVENTAIRE, COL_NOTEPERSO, COL_NIVEAU, COL_DEFENSE, COL_INITIATIVE, COL_FOR, COL_DEX, COL_CON, COL_INT, COL_SAG, COL_CHA}, COL_NOM + " LIKE \"" + nom +"\"", null, null, null, null);
        return cursorToPerso(c);
    }

    public Perso getPersoById(int id){
        //Récupère dans un Cursor les valeur correspondant à un livre contenu dans la BDD (ici on sélectionne le livre grâce à son titre)
        Cursor c = bdd.query(TABLE_PERSO, new String[] {COL_IDPERSO, COL_NOM, COL_CLASSE, COL_RACE, COL_DESCRIPTION, COL_INVENTAIRE, COL_NOTEPERSO, COL_NIVEAU, COL_DEFENSE, COL_INITIATIVE, COL_FOR, COL_DEX, COL_CON, COL_INT, COL_SAG, COL_CHA}, COL_IDPERSO + " LIKE \"" + id +"\"", null, null, null, null);
        return cursorToPerso(c);
    }
