...
import procorp.applijdr.database.*;

/**
 * Created by benja on 23/11/2017.
 */

public class FragmentPerso2 extends Fragment {
    View myView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.layout_perso2, container, false);
        PersoManager persoManager = new PersoManager(this.getActivity().getBaseContext());
        persoManager.open();
        perso = persoManager.getPersoById(2);
